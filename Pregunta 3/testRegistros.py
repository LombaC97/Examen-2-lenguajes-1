...
class TestRegistrosMethods(unittest.TestCase):
    ...
    def test_91(self):
        ...
        self.assertTrue(empaquetado in output and no_empaquetado in output and optimizado in output and struct_no_empaquetado in output and struct_empaquetado in output and optimizado in output)

    #Para finalizar, probemos el caso de un UNION con un Struct dentro
